  ...
  return filters
    .reduce(function(res, filter) {
      ...
      switch (this.schema.attributes[parts[0]]) {
        case String:
          res[parts[0]] = {AttributeValueList: [{S: parts[2]}], ComparisonOperator: parts[1]};
          break;
        case Number:
          res[parts[0]] = {AttributeValueList: [{N: JSON.stringify(parts[2])}], ComparisonOperator: parts[1]};
          break;
        case Buffer:
          res[parts[0]] = {AttributeValueList: [{B: parts[2]}], ComparisonOperator: parts[1]};
          break;
      }
